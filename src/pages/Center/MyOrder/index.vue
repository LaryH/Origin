    ...
    <div class="order-content">
      ...
      <div class="orders">
        <table class="order-item" v-for="record in records" :key="record.id">
          ...
          <tbody>
            <tr
              v-for="(orderDetailList, index) in record.orderDetailList"
              :key="orderDetailList.id"
            >
              <td width="60%">
                <div class="typographic">
                  <img :src="orderDetailList.imgUrl" />
                  <a href="#" class="block-text">{{
                    orderDetailList.skuName
                  }}</a>
              ...
              <template v-if="index === 0">
                ...
                <td :rowspan="index" width="13%" class="center">
                  <ul class="unstyled">
                    ...
                    <li>{{ orderDetailList.paymentWay }}</li>
                  </ul>
                </td>
                <td :rowspan="index" width="8%" class="center">
...
export default {
  ...
  methods: {
    async getMyOrderInfo(currentPage = 1) {
